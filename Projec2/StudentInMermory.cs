...
namespace Projec2
{
    public class StudentInMermory : StudentBase
    {
        ...
        public StudentInMermory(string firstName, string lastName) : base(firstName, lastName)
        {
            grades = new List<double>();
        }

        public void ChangeStudentOldName(string newName)
        {
